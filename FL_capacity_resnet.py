...
from update_capacity import LocalUpdate, test_inference
...
if __name__ == '__main__':
    ...
    conv = conv = ['layer1.0.convbnrelu_1.conv.weight', 'layer1.0.convbnrelu_1.conv.weight', 'layer1.0.convbn_2.conv.weight', 
            'layer1.1.convbnrelu_1.conv.weight', 'layer1.1.convbn_2.conv.weight', 'layer2.0.convbnrelu_1.conv.weight', 
            'layer2.0.convbn_2.conv.weight', 'layer2.0.shortcut.conv.weight', 'layer2.1.convbnrelu_1.conv.weight', 
            'layer2.1.convbn_2.conv.weight', 'layer3.0.convbnrelu_1.conv.weight', 'layer3.0.convbn_2.conv.weight', 
            'layer3.0.shortcut.conv.weight', 'layer3.1.convbnrelu_1.conv.weight', 'layer3.1.convbn_2.conv.weight', 
            'layer4.0.convbnrelu_1.conv.weight', 'layer4.0.convbn_2.conv.weight', 'layer4.0.shortcut.conv.weight', 
            'layer4.1.convbnrelu_1.conv.weight', 'layer4.1.convbn_2.conv.weight']
    para = []
    ...
    for epoch in tqdm(range(args.epochs)):
        ...
        for j in range(args.num_users):
            w = W[j*args.W:(j+1)*args.W].view(1, -1)
