...
from models import ResNet18, AlexNetNormal, VGG, MobileNetV2, InceptionV3
...
if __name__ == '__main__':
    ...
    if args.model == 'alexnet':
        ...
        global_model = nn.DataParallel(InceptionV3(), device_ids = [0,1])
    else:
    ...
    for epoch in tqdm(range(args.epochs)):
        ...
        for idx in idxs_users:
            ...
            w, loss= local_model.normal_update(model=copy.deepcopy(global_model))
